<?php
class Estandarte_Categorised_Posts extends Oec_Widget_Base
{
    /**
    ...
    function __construct()
    {
        ...
        $widget_ops = array(
            'classname' => 'estandarte_categorised_posts',
            'description' => __('Displays posts AA from selected category.', 'magazine-7'),
            'customize_selective_refresh' => true,
        );

        parent::__construct('estandarte_categorised_posts', __('AA - Estandarte Posts', 'magazine-7'), $widget_ops);
    }
    ...
    public function widget($args, $instance)
    {
        ...
        $number_of_posts = isset($instance['oec_posts_number']) ? $instance['oec_posts_number'] : '8';
        $number_of_col = isset($instance['oec_col_number']) ? $instance['oec_col_number'] : '4';
    ...
    <?php endif; ?>
        ...
        <div class="widget-wrapper">
            <div class="row oec_especial_post">
                <?php
                if ($all_posts->have_posts()) :
                    while ($all_posts->have_posts()) : $all_posts->the_post();
                        ...
                        global $post;
                            ?>
                            <div class="col col-five oec_col_<?php echo $number_of_col; ?>" data-mh="em-double-column" >
    ...
    public function form($instance)
    {
        ...
        if (isset($categories) && !empty($categories)) {
            ...
            echo parent::m7_generate_text_input('oec_posts_number', __('Numero de Posts', 'magazine-7'), __('8', 'magazine-7' ));
            echo parent::m7_generate_text_input('oec_col_number', __('Numero de colunas', 'magazine-7'), __('4', 'magazine-7' ));
